...
object ETL extends App {
  ...
  // Change the File extension in the below code. In this `parquet.gz` is used.
  ...
  filterParquetFiles.map { s3Object =>
    ...
    /**
     * Change the file format in this code
     * As in this template custom format (AvroParquet Format) is used.
     */
